...
<div class="container">
    <div class="section white center">
        <h2 class="header text-center font-weight-light " style="padding:20px; padding-bottom: 30px;" id="type1">ເດີ່ນກິລາເຕະບານ TPC<img src="images/logo.png" width="40px" /></h2>
