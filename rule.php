...
<div class="container">
	<div class="section white center">
		<h2 class="header text-center font-weight-light " style="padding:20px; padding-bottom: 30px;" id="type1">ກົດລະບຽບຂອງສະໜາມກິລາເຕະບານ TPC  </h2>
		<div class="row">
			<div class="col-sm-6">
				<div class="card">
					<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-body">
							<h5 class="text-center">TPC FOOBALL</h5><br>
							<img height="200px" width="400px" style="object-fit: contain;" src="images/court.png" alt=""><br><br>
							<a href="login.php" class="btn btn-outline-primary">ຈອງເດີ່ນບານ</a>
						</div>
					</div>
				</div>
		</div>
...
<script>
	var typed = new Typed('#type1', {
		...
		strings: ['ກົດລະບຽບຂອງເດີ່ນບານ TPC'],
		smartBackspace: true,
		loop: true,
		typeSpeed: 100,
		backSpeed: 100,
