...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">TPC Admin <i class="bi bi-life-preserver text-primary"></i>
        </div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="admin.php">
            ...
            <span>ຜູ້ຈັດການ</span></a>
    </li>
    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
            <i class="bi bi-tools text-warning"></i>
            <span class="edit">ຈັດການຂໍ້ມູນ</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item text-info" href="employee.php"><i class="bi bi-person-circle text-info"></i> ຈັດການຂໍ້ມູນພະນັກງານ </a>
                <a class="collapse-item text-info" href="customer.php"> <i class="bi bi-person-video2 text-info"></i> ຈັດການຂໍ້ມູນລູກຄ້າ</a>
                <a class="collapse-item text-info" href="court.php"><i class="bi bi-cash text-info"></i> ຈັດການຂໍ້ມູນເດີ່ນເຕະບານ </a>
                <a class="collapse-item text-info" href="time.php"><i class="bi bi-alarm text-info"></i> ຈັດການຂໍ້ມູນເວລາ </a>
                <a class="collapse-item text-info" href="price.php"><i class="bi bi-coin text-info"></i> ຈັດການຂໍ້ມູນລາຄາເດີ່ນ </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse" aria-expanded="true" aria-controls="collapseUtilities">
            ...
            <span class="booking">ລາຍການຈອງ</span>
        </a>
        <div id="collapse" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="booking_today.php">ລາຍການຈອງມື້ນີ້</a>
                <a class="collapse-item" href="total_booking.php">ລາຍການຈອງທັງໝົດ</a>
                <a class="collapse-item" href="dulation_booking.php">ຄົ້ນຫາຊ່ວງເວລາການຈອງ</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                        ...
                        ?>
                                <a class="dropdown-item d-flex align-items-center" href="view_booking.php?id=<?php echo $row['id'] ?>">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-gray-500"><?php echo $row['date_booking'] ?> ເວລາ:<?php echo $row['time_id'] ?></div>
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="admin.php">
                            <i class="bi bi-pencil-square fa-sm fa-fw mr-2 text-primary"></i>
                            ແກ້ໄຂ
                        </a>
