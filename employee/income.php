  ...
  <div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<a href="income.php?p=daily" class="btn btn-info">ລາຍຮັບປະຈຳວັນ</a> 
			<a href="income.php?p=monthy" class="btn btn-success">ລາຍຮັບປະຈຳເດືອນ</a> 
			<a href="income.php?p=yearly" class="btn btn-warning">ລາຍຮັບປະຈຳປີ</a> 
		</div>
	</div>
</div>
    <?php
